...
const About = () => {
  const skills = [
    ...
    'HTML/CSS', 'Git', 'Docker', 'AWS', 'MongoDB', 'PostgreSQL'
  ];
  ...
  const highlights = [
    ...
    },
    {
      ...
      description: 'Expertise in optimizing applications for speed and efficiency'
    }
  ];
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                both functional and delightful. When I'm not coding, you can find me exploring new 
